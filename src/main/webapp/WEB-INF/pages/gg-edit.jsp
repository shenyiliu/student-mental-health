			...
			<!-- 内容头部 /-->
				...
				<section class="content"> <!--订单信息-->
					<div class="panel panel-default">
						...
						<input type="hidden" id="noticeID" value="<%=request.getParameter("id")%>" />
						<div class="row data-type">
							...
							<div class="col-md-2 title">作者姓名</div>
							<div class="col-md-10 data">
								<input type="text" id="name" class="form-control" placeholder="姓名"
									   value="${notice.name}">
							</div>

							<div class="col-md-2 title rowHeight2x">内容</div>
							<div class="col-md-10 data rowHeight2x" style="height: 300px">
							<textarea class="form-control" rows="3" placeholder="公告内容"
									  name="productDesc" id="context" style="height: 310px;padding: 10px" >${notice.context}</textarea>
							</div>
			...
			if (name!=""&&title!=""&&context!=""){
				$.ajax({
					...
					success:function (info) {
						if (info>0){
							layer.msg("修改成功");
							window.location.href="${pageContext.request.contextPath}/url/gg-list";
						}else {
							alert("修改失败");
						}
					}
