...
<link rel="stylesheet"
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/permission/updPermissionById"
				method="post">
				<!-- 正文区域 -->
						...
						<div class="row data-type">
							...
							<div class="col-md-4 data">
								<input type="text" class="form-control" name="name"
									   placeholder="权限名称" value="${list.name}">
							</div>
							...
							<div class="col-md-4 data">
								<input type="text" class="form-control" name="uri"
									   placeholder="权限请求路径" value="${list.uri}">
							</div>

							<div class="col-md-2 title">权限码</div>
							<div class="col-md-4 data">
								<input type="text" class="form-control" name="code"
									   placeholder="权限码" value="${list.code}">
							</div>
						</div>
					</div>
				<!--订单信息/--> <!--工具栏-->
