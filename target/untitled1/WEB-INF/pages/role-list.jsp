	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${pageContext.request.contextPath}/url/role-list">角色管理</a></li>
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/url/role-add'">
	...
	<script
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				...
				getRoleListPageHelper($pageNum,$pageSize);
			});
			
			function getRoleListPageHelper(pageNum,pageSize){
				$.ajax({
					url:$webName + "/role/roleSelect",
					type:"post",
			...
			function addTable(pageInfo){
				...
				$.each(pageInfo.list,function(index,roleinfo){
					$("tbody").append("<tr>"+
							"<td>"+ roleinfo.id +"</td>"+
							"<td>"+ roleinfo.name +"</td>"+
							"<td>"+ roleinfo.intro +"</td>"+
							"<td class='text-center'>"+
								"<a href='#' class='btnDetail btn bg-olive btn-xs'>详情</a>"+
			...
			function addPageInfo(pageInfo){
				...
				$("#pageDiv").append("总共"+ pageInfo.pageNum +"页，共"+ pageInfo.total +"条数据。 每页");
			...
			$(document).on("click",".btnDetail",function(){
				...
				window.location.href="${pageContext.request.contextPath}/product/getRoleInfoDetailById?userID="+id;
			});
			
			$(document).on("click",".btnUpdate",function(){
				var id=$(this).parents("tr").children("td").eq(0).text();
				window.location.href=$webName +"/role/roleSelectID?id="+id;
			});

			//删除按钮
			$(document).on("click",".btnDelete",function(){
				var id=$(this).parents("tr").children("td").eq(0).text();
				window.location.href=$webName +"/role/roleDeleteID?id="+id;
			});
