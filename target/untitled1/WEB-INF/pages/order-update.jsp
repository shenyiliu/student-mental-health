	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${pageContext.request.contextPath}/url/order-list">订单管理</a></li>
			...
			<form
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" readonly="readonly" name="id"
								   placeholder="订单ID" value="${order.id}">
						</div>
						<div class="col-md-2 title">联系电话</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="phone" readonly="readonly"
								   placeholder="联系电话" value="${order.phone}">
						</div>
						<div class="col-md-2 title" >姓名</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="name" readonly="readonly"
								placeholder="用户名称" value="${order.name}">
						</div>
						<div class="col-md-2 title">下单时间</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="orderTime" readonly="readonly"
								placeholder="下单时间" value="${order.orderTime}">
						</div>
						<div class="col-md-2 title">地址</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="address" readonly="readonly"
								placeholder="地址" value="${order.address}">
						</div>
						...
						<div class="col-md-4 data">
							<select class="form-control select2" style="width: 100%"
								id="state">
								<option value="0" selected="selected">未接</option>
				...
				<div class="box-tools text-center">
					<button type="button" class="btn bg-maroon" id="btnSave">保存</button>
