...
<link rel="stylesheet"
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a href="${pageContext.request.contextPath}/url/permission-list">资源权限管理</a></li>
			...
			<form
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-2 title">权限类型</div>
						<div class="col-md-4 data">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="uri"
								placeholder="权限请求路径" value="">
						</div>

						<div class="col-md-2 title">权限码</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="code"
								   placeholder="权限码" value="">
						</div>
					</div>
				</div>
				<!--订单信息/--> <!--工具栏-->
				<div class="box-tools text-center">
					<button type="button" id="btnSave" class="btn bg-maroon">保存</button>
	...
	<script>
		...
		$(document).ready(function() {
			// 激活导航位置
			setSidebarActive("order-permission");
		});
		...
		$(function () {
			$("#btnSave").click(function () {
				...
				if (name!=""&&type!=""&&name!=""&&type!=""){
					$.ajax({
						url:"${pageContext.request.contextPath}/permission/permissionInsert",
						data:{
							name:name,
							type:type,
							uri:uri,
						...
						success:function (info) {
							if (info!=1){
								...
								layer.msg("添加成功");
								window.location.href="${pageContext.request.contextPath}/url/permission-list";
							}
